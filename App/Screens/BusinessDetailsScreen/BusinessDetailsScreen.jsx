...
import { View, Text, Image, StyleSheet, TouchableOpacity, Modal, Linking, FlatList } from 'react-native';
...
export default function BusinessDetailsScreen() {
        ...
        <>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.subContainer}>
              ...
              <Text style={{ color: Colors.PRIMARY, backgroundColor: Colors.PRIMARY_LIGHT, padding: 6, borderRadius: 6, fontSize: 14 }}>{business.category?.name}</Text>
            </View>
  ...
  const renderSeparator = () => {
    return <View style={{ borderWidth: 0.4, borderColor: Colors.GRAY, marginTop: 20, marginBottom: 20 }} />;
  };
