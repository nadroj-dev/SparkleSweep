  ...
  return (
    <View style={{alignItems:'center'}}>
      ...
      <Text style={{ fontSize: 25, color: Colors.WHITE, textAlign: 'center' }}>
          Unlock the power of
          <Text style={{ fontWeight: 'bold' }}> Home Transformation</Text> with, Cleaning, Repairing, Painting, and Shifting Services!
        </Text>
        <Text style={{ fontSize: 17, color: Colors.WHITE, textAlign: 'center', marginTop: 20 }}>
          Explore a world of possibilities with Sparkle Sweep, connecting you to top professionals for every task.
        </Text> 
